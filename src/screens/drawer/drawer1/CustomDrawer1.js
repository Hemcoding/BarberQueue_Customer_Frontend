    ...
    <SafeAreaView style={styles.container}>
      ...
      <Animated.View
        style={[
          ...
          styles.marginTop,
          viewStyles2('top'),
          {backgroundColor: '#594C48', display: 'flex', justifyContent: 'center'},
        ]}>
        {/* <View style={styles.iconContainer}>
          <Icon name="logo-electron" type={Icons.Ionicons} size={20} />
        </View> */}
        <Text style={styles.headerTitle}>BarberQueue</Text>
      </Animated.View>
      {/* Drawer List Item */}
      <Animated.ScrollView
        ref={scrollRef}
